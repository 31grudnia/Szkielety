...
namespace API.Controllers
{
    ...
    public DbController(DataContext db)
    {
        ...
        [Authorize]
        [HttpPost("dodajWynagrodzenie")] // dodaje do bazy danych rekord dla tabeli wynagrodzenia 
        ...
        [Authorize]
        [HttpPost("dodajCeneProduktu")] // dodaje do bazy danych rekord dla tabeli CenyProduktow
        ...
        [HttpPost("dodajAllWynagrodzenia")] //do zainicjalizowania bazy danymi
        ...
        [HttpPost("dodajAllCeny")] //do zainicjalizowania bazy danymi
        ...
        [Authorize] // wymagany jwt
        [HttpDelete("usunWynagrodzenie/{idW}")]  // usuwa rekord z tabeli Wynagrodzenia
        ...
        [Authorize]
        [HttpDelete("usunProdukt/{idW}")] // usuwa rekord z tabeli CenyProduktów
