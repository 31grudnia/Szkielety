...
namespace API.Json
{
    public class Zapisz
    {
         public static void SaveXML(List<Wojewodztwo> woj)
        {
            ...
            var path = Directory.GetParent(workingDirectory).Parent.Parent.FullName + "/Desktop/Szkielety/API/Json/Assets/BazaXML.xml";
        ...
        {
            string workingDirectory = Environment.CurrentDirectory;
            var path = Directory.GetParent(workingDirectory).Parent.Parent.FullName + "/Desktop/Szkielety/API/Json/Assets/BazaJSON.json";
